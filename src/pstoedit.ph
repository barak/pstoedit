...
//
 ...
 " exch dup  ",
 " { 308 pscover ",
 " 					(colorimage with more than one datasrc not supported for this backend due to lack of support for FILE files\n) true printwarning ",
 " exch -colorimage ",
 " }  ",
 " { 309 pscover ",
 " ImageTraceBoundingBox ",
 ...
 " }  ",
 " { 362 pscover ",
 " (TEST!! : not processing as FILE image \\n) print ",
 " pstoedit.image.realproc ",
 " }  ",
 " ifelse ",
 " }  ",
 ...
 " /dicttype eq  ",
 " { 364 pscover ",
 " 					(Level 2 version of image and imagemask not supported for this backend (due to lack of support for FILE files)\n) true printwarning ",
 " pstoedit.image.realproc ",
 "  ",
 " }  ",
 " { 365 pscover ",
