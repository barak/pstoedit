/*
   ...
   Copyright (C) 1998 - 2001 Wolfgang Glunz
...
static const OptionDescription driveroptions[] = {
	...
	OptionDescription("-n",0,"emulate narrow fonts"),
...
emulateNarrowFonts(false), drawBoundingBox(true), pruneLineEnds(false)
{
	...
	if (driveroptions_p != NIL) {
		...
		if (strstr(driveroptions_p, "-n") != NIL) {
...
void drvWMF::show_image(const Image & image)
{
